...
their **upstream-declared licenses**, and gives verifiable primary-source URLs. Original entries were verified on
2026-07-17 by reading the upstream `LICENSE` text / PyPI metadata directly. The SimpleITK entry was added and
verified against its versioned PyPI page on 2026-09-07; that addition does not re-verify the older entries.
...
| **SimpleITK** (3-D rigid registration; imported at runtime, no bundled binaries) | 2.5.3 | **Apache-2.0**, as declared by the package publisher | [Versioned PyPI page](https://pypi.org/project/simpleitk/2.5.3/) · [Upstream licence statement](https://simpleitk.org/about.html#license) |
...
*This file was generated by cross-checking the code against upstream primary sources; verification dates are stated above.
